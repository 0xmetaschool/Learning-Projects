...
The DEX utilizes the DeepBook protocol, which is a central limit order book (CLOB) system for managing buy and sell orders. Now imagine DeepBook as a intermediate entity which manages your buy and sell orders for you. 
