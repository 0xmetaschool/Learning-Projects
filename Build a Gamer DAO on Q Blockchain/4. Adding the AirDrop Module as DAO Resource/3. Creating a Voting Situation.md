...
4. Go back to the DAO dashboard and move to the “Governance” section from the side bar. Here, you will find two pending proposals. Please re-load the site if you don't find any proposal. **Please make sure you have *two* proposals on your dashboard. If you see only one please re-run the last command, we ran.**
