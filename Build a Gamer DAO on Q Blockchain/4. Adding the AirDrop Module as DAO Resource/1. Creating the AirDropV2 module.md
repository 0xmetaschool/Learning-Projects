...
**Note:** No need to do this if you are already using the [boilerplate GitHub repository](https://github.com/0xmetaschool/Q-boilerplate-code) to run your project.

## Let’s start coding

Navigate to `contracts/AirDropV2.sol` file of your existing hardhat project or create a new file and start writing the code for 2nd version of AirDrop module.
...
Here’s how the complete code for `contracts/AirDropV2.sol` file looks like.
