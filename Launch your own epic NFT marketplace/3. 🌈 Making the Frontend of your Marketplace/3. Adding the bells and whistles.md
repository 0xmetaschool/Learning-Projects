...
-   Then using the signer, the contract ABI, and the address of the contract you deployed to Sepolia, we create a new instance of a contract. We can interact with this local instance of the contract as if we are interacting with the deployed contract.
