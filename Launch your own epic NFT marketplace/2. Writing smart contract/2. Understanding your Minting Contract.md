...
1.  First we setup a counter (\_totalMinted) to keep track of the total number of NFTs that we have minted.
...
To set the total supply we do two things:
