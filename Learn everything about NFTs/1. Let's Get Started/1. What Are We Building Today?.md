...
gm everyone 🌈, we are very excited to bring the exciting course for developers just like you, who want to get started with the NFTs (Non-Fungible Tokens) ecosystem!
...
Learning new tech is always easier when you got some prior knowledge. So, before diving into NFTs, we recommend brushing up on the following:
