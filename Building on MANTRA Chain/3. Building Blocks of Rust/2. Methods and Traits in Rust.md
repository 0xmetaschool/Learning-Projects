...
1. Let’s create a new file in `src` folder with the name `methodExample.rs`.
...
![86.png](Lesson%2012%20Methods%20and%20Traits%20in%20Rust%202829903964074c76a1fc3e75d92e8522/86.png)
...
- Create a new file with the name [`traitExample.rs`](http://traitExample.rs) and add the following code:
...
![87.png](Lesson%2012%20Methods%20and%20Traits%20in%20Rust%202829903964074c76a1fc3e75d92e8522/87.png)
