...
1. Let’s write the complete code, first create a new file in `src` folder with the name `struct_example.rs`.
2. Add the following code in `struct_example.rs` file
...
![nft-mantra-c2 (21).png](https://github.com/0xmetaschool/Learning-Projects/blob/main/assests_for_all/Building%20on%20Mantra%20-%20C2/3.%20Building%20Blocks%20of%20Rust/1.%20Structs%20in%20Rust%20Building%20Blocks%20for%20Your/nft-mantra-c2_(21).png?raw=true)
...
1. Here is the complete code and don’t forget to add it to `main.rs`:
...
![nft-mantra-c2 (22).png](https://github.com/0xmetaschool/Learning-Projects/blob/main/assests_for_all/Building%20on%20Mantra%20-%20C2/3.%20Building%20Blocks%20of%20Rust/1.%20Structs%20in%20Rust%20Building%20Blocks%20for%20Your/nft-mantra-c2_(22).png?raw=true)
