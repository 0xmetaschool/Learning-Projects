# Lesson 10: Functions in Rust: Your Code's Action Heroes
...
1. **Main Function (`main`):**
    ...
    - `println!("Area of circle with radius {}: {}", radius, circle_area);`: This line prints a formatted message to the console, stating the radius of the circle and the calculated area. The `{}` placeholders are replaced by the values of the `radius` and `circle_area` variables, respectively.
        ...
        ![nft-mantra-c2 (17).png](Lesson%2010%20Functions%20in%20Rust%20Your%20Code's%20Action%20Her%20154740a573104091832aad243fdda4db/nft-mantra-c2_(17).png)
...
![nft-mantra-c2 (18).png](Lesson%2010%20Functions%20in%20Rust%20Your%20Code's%20Action%20Her%20154740a573104091832aad243fdda4db/nft-mantra-c2_(18).png)
...
![nft-mantra-c2 (19).png](Lesson%2010%20Functions%20in%20Rust%20Your%20Code's%20Action%20Her%20154740a573104091832aad243fdda4db/nft-mantra-c2_(19).png)
...
![nft-mantra-c2 (20).png](Lesson%2010%20Functions%20in%20Rust%20Your%20Code's%20Action%20Her%20154740a573104091832aad243fdda4db/nft-mantra-c2_(20).png)
