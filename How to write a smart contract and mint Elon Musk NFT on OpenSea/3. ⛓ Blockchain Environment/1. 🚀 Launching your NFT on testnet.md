...
Now select Ethereum as Network and Goerli as chain and continue. We don’t need any add-on so click create endpoint now.
...
![](https://i.imgur.com/ThSA5X4.png)

* Now let’s go back to the Metamask add network form and paste the HTTPS in New RPC Url field with 5 as Chain ID, 
